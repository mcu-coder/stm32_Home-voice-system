...
* @{
*/
#define stepperMotor_LEN                           1
#define humidifier_LEN                           1
#define smokeAlarm_LEN                           1
#define model_LEN                           1

#define LED_RATIO                         1
#define LED_ADDITION                      0
#define LED_MIN                           0
#define LED_MAX                           100
#define LED_LEN                           1
...
#define humidness_RATIO                         1
#define humidness_ADDITION                      0
#define humidness_MIN                           0
#define humidness_MAX                           99
#define humidness_LEN                           1
#define fan_RATIO                         1
#define fan_ADDITION                      0
#define fan_MIN                           0
#define fan_MAX                           100
#define fan_LEN                           1
#define lux_RATIO                         1
...
typedef struct {
    bool valuestepperMotor;
    bool valuehumidifier;
    bool valuesmokeAlarm;
    uint32_t valuemodel;
    uint32_t valueLED;
    uint32_t valuetemperature;
    uint32_t valuehumidness;
    uint32_t valuefan;
    uint32_t valuelux;
    uint32_t valuesmoke;
} dataPoint_t;
...
/** User Area Device State Structure */
typedef struct {
    uint8_t flagstepperMotor:1;
    uint8_t flaghumidifier:1;
    uint8_t flagsmokeAlarm:1;
    uint8_t flagmodel:1;
    uint8_t flagLED:1;
    uint8_t flagtemperature:1;
    uint8_t flaghumidness:1;
    uint8_t flagfan:1;
    uint8_t flaglux:1;
    uint8_t flagsmoke:1;
} dataPointFlags_t;
